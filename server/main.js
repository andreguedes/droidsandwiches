...
const sandwiches = {
	1: {id: 1, name: 'X-Bacon', ingredients: [ingredients[2], ingredients[3], ingredients[5], ingredients[6]], image: 'https://goo.gl/W9WdaF'},
	2: {id: 2, name: 'X-Burger', ingredients: [ingredients[3], ingredients[5], ingredients[6]], image: 'https://goo.gl/Cjfxi9'},
	3: {id: 3, name: 'X-Egg', ingredients: [ingredients[3], ingredients[4], ingredients[5], ingredients[6]], image: 'https://goo.gl/x4rNIq'},
	4: {id: 4, name: 'X-Egg Bacon', ingredients: [ingredients[1], ingredients[2], ingredients[3], ingredients[4], ingredients[5], ingredients[6]], image: 'https://goo.gl/2L0lqg'}
}
